...
const someRtnUsingOldSchoolCallback = (var1, callback) => {
    if (callback && typeof callback === "function") {
        var1 === "err" ? // fire the callback either way
...
export { someRtnUsingOldSchoolCallback, internalNameRtn };
export { someRtnWithAPromise }
export { anotherRtnWithAPromise, ontarioTransferPaymentPromise, reverseNameWithAPromise }